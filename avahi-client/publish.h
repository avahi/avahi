...
int avahi_entry_group_add_service(
    ...
    AvahiPublishFlags flags /**< Usually AVAHI_PUBLISH_DEFAULT, unless you know what you do */,
...
int avahi_entry_group_add_service_subtype(
    ...
    AvahiPublishFlags flags  /**< Only != AVAHI_PUBLISH_DEFAULT if you really know what you do */,
